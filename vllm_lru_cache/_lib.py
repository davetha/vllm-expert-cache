...
_SEARCH = (
    lambda: os.environ.get("VLLM_LRU_LIB"),
...
def lib():
    ...
    if _LIB is None:
        ...
        #        table, map_cold, slot_expert, slot_stamp, routed, step, miss, n_miss, stream)
        h.lru_manage.restype = ctypes.c_int
        h.lru_manage.argtypes = [ctypes.c_void_p] + [ctypes.c_int] * 5 + [ctypes.c_void_p] * 9
